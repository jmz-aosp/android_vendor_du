...
# Set all versions
JMZ_VERSION := Jmz_$(JMZ_BUILD)_$(ANDROID_VERSION)_$(shell date -u +%Y%m%d).$(JMZ_VERSION)-$(JMZ_BUILD_TYPE)
JMZ_MOD_VERSION := Jmz_$(JMZ_BUILD)_$(ANDROID_VERSION)_$(shell date -u +%Y%m%d).$(JMZ_VERSION)-$(JMZ_BUILD_TYPE)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    ro.jmz.version=$(JMZ_VERSION) \
    ro.mod.version=$(JMZ_BUILD_TYPE)-v2.0
